...
class ColorCode:
    ...
    def simulator(self) -> Simulator:
        ...
        if self._simulator is None:
            self._simulator = Simulator(
                ...
                circuit_type=self.circuit_type,
                num_obs=self.num_obs,
                detectors_checks_map=self.detectors_checks_map,
    ...
    def get_detector_type(self, detector_id: int) -> Tuple[PAULI_LABEL, COLOR_LABEL]:
        """Get the Pauli and color type of a detector. Delegated to simulator."""
        return self.simulator.get_detector_type(detector_id)

    def get_observable_pauli(self, observable_id: int) -> PAULI_LABEL:
        """Get the Pauli type of an observable. Delegated to simulator."""
        return self.simulator.get_observable_pauli(observable_id)
    ...
    def get_detector(self, detector_id: int) -> Tuple[ig.Vertex, int]:
        ...
        given detector ID. Delegated to simulator.
        ...
        """
        return self.simulator.get_detector(detector_id)
    ...
    def errors_to_qubits(
        ...
        qubit indices. Delegated to simulator.
        ...
        """
        return self.simulator.errors_to_qubits(errors)
